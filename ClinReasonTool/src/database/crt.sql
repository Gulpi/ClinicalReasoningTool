...
--   Script Created at  : 01.12.2017 13:08:15 
--   Physical Location  :  
--   Notes              :  
--

-- Object Counts: 
--   Indexes: 15        Columns: 18         
--   Sequences: 3 
--   Tables: 24         Columns: 225        
--   Views: 1           
...
CREATE TABLE RELATION_SYNDROME
(
  ID           NUMBER                           NOT NULL,
  SYNDROME_ID  NUMBER,
  CHILD_ID     NUMBER
...
CREATE INDEX REL_DIAG_IDX ON RELATION_DIAGNOSIS
(ID)
LOGGING
NOPARALLEL;


CREATE INDEX REL_MGR_IDX ON RELATION_MANAGEMENT
(ID)
LOGGING
NOPARALLEL;
