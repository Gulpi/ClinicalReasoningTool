	...
	public AppBean(){
	   ...
	   //doTestStuff(context);
	    ...
	    try {
			...
			CRTLogger.out("End AppBean PerformantSpacyProcessor.getInstance:" + (System.currentTimeMillis()-startms) + "ms", CRTLogger.LEVEL_PROD);
			
			// test run, shouldn't tale long!
			...
			CRTLogger.out("End AppBean text_result:" + text_result + "; " + (System.currentTimeMillis()-startms1) + "ms", CRTLogger.LEVEL_PROD);
		} catch (Exception e) {
